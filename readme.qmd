...
Being a proper ggplot geom, it supports all of the standard features of ggplot2, such as **facets** and **themes** as shown in the code below (output suppressed for brevity).
